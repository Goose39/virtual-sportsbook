      ...
      <div className="match_view">
        ...
        <div class="market">
          ...
          <div class="outcome">
            ...
            <div class="odd" onClick={() => this.context.createBet(match.sport, match.league, match.home_team, match.home_odd, match.matchId, `${match.home_team} v ${match.away_team}`)}>{match.home_odd}</div>
          </div>
          <div class="outcome">
            <div class="team">{match.away_team}</div>
            <div class="odd"onClick={() => this.context.createBet(match.sport, match.league, match.away_team, match.away_odd, match.matchId, `${match.home_team} v ${match.away_team}`)}>{match.away_odd}</div>
          </div>        
        </div>      
      </div>
